...
Page({
    ...
    onLoad: function (options) {
        var that = this;
        var sysinfo = wx.getSystemInfoSync().windowHeight;// 屏幕可用区域的高度
    ...
    selectMenu: function (e) { // 左侧分类菜单的选择事件
    ...
    scroll: function (e) { //右侧菜品列表滚动事件
        //通过滚动条的位置来设置左侧分类的激活样式。【需要重写】
